/**
 * The Poster component in TypeScript React renders information about a title, including image, status,
 * year, episodes, duration, rating, external links, streaming details, producers, and type, along with
 * additional Info and MoreInfo components.
 * @param {PosterProps}  - The `Poster` component takes the following props:
 * @returns The `Poster` component is being returned. It takes in various props such as `type`,
 * `titles`, `image`, `status`, `year`, `episodes`, `duration`, `rating`, `external`, `streaming`, and
 * `producers`. Inside the component, there is JSX code that displays information about a poster,
 * including an image, status, rating, year, duration,
 */
