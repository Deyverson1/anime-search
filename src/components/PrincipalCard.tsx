/* This code snippet is a TypeScript React component named `PrincipalCard`. It receives props such as
`type`, `favorites`, `rank`, `popularity`, `members`, `score`, `genres`, `synopsis`, `trailer`,
`background`, and `scored_by`. */
